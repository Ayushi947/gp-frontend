...
const FAQ_ITEMS = [
  {
    ...
    answer: 'You can enroll by clicking the "Enroll Now" button on your dashboard. Follow the step-by-step process to choose your contribution amount and investment options.',
  },
  {
    question: 'When will my contributions be deducted from my paycheck?',
    answer: 'Contributions are deducted from each paycheck according to your employer\'s payroll schedule. You can view your contribution history on the Contributions page.',
  },
  {
    question: 'How do I change my contribution amount?',
    answer: 'Go to the Contribution page and click "Update Contribution Rate". Changes typically take effect in the next pay period.',
  },
  {
    question: 'Can I change my investment allocation?',
    answer: 'Yes! Go to the Portfolio page and click "Rebalance Portfolio" or use the Transfers page to move funds between different investments.',
  },
  {
    question: 'How do I update my beneficiaries?',
    answer: 'Navigate to Settings and select the Beneficiaries section. You can add, update, or remove beneficiaries at any time.',
  },
  {
    question: 'What happens if I leave my job?',
    answer: 'You have several options: leave your money in the plan, roll it over to an IRA, roll it to your new employer\'s plan, or take a distribution (tax implications apply). Contact support for personalized guidance.',
  },
];
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Get help with your 401(k) account
            </p>
          </div>
        </div>
          ...
          <TabsContent value="faqs" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Find answers to common questions about your 401(k) account
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <form onSubmit={handleSubmit(onSubmitTicket)}>
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <Input
                  id="title"
                  placeholder="Brief description of your question (min 5 characters)"
                  {...register('title')}
                ...
                {watch('title') && (
                  <p className="text-xs text-muted-foreground">
                    {watch('title').length}/255 characters (minimum 5)
                  </p>
                )}
              </div>
